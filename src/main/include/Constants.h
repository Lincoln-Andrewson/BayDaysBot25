...
namespace ShooterConstants {
    constexpr int kLeftShooterMotorCanID = 12;
    constexpr int kRightShooterMotorCanID = 11;
    constexpr double kLeftShooterSpeed = 0.4;
    constexpr double kRightShooterSpeed = 0.4;
}
